...
const ContentChart = () => {
  const data = {
    ...
    datasets: [
      {
        label: '',
        data: [12, 12, 12, 8, 8, 8, 4, 4, 4, 4],
        backgroundColor: [
          'purple', 'purple', 'purple', 'mediumorchid', 'mediumorchid', 'mediumorchid', 'gray', 'gray',
          'gray', 'gray'
        ],
    ...
    <Container fluid className="p-0 mt-4">
      <Card className="w-100">
        <Card.Body className="p-0">
          <h3 className="chart-title mb-3 mt-3 ml-2">{`Patient Centricity (Trial)- High, Medium, Low`}</h3>
